...
const Keyboard = () => {
    ...
    const renderBackspace = () => {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fillRule="currentColor" className="bi bi-backspace" viewBox="0 0 16 16">
    ...
    const renderEnter = () => {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fillRule="currentColor" className="bi bi-box-arrow-in-left" viewBox="0 0 16 16">
